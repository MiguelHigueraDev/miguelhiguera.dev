      ...
      {!loading && statusMap[status.discord_status] ? (
        <>
          <div className="md:flex gap-2">
            ...
            {gameActivity && (
              <div>
                <button target="_blank" data-tooltip-id="game-playing" data-tooltip-place="bottom" className="spotify-button select-none rounded-xl py-2 px-3 gap-2 items-center inline-flex text-gray-300 bg-neutral-800 mt-3">
